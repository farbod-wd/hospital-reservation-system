        ...
        <ul id="users">
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{route('paitients.index')}}">لیست بیماران</a></li>
                    <li><a href="{{route('paitients.create')}}">افزودن بیماران</a></li>
                </ul>
            </li>
            <li>
                <a href="#">کاربران</a>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{route('roles.create')}}">اضافه کردن نقش</a></li>
                </ul>
            </li>
            <li>
                <a href="#"> دکتر ها</a>
                <ul>
                    ...
                    <li><a href="{{route('doctors.create')}}">اضافه کردن متخصص</a></li>
                </ul>
            </li>
            <li>
                <a href="#">نوبت</a>
                <ul>
                    ...
                    <li><a href="{{route('turns.index')}}">لیست نوبت ها</a></li>
                    <li><a href="{{route('turns.create')}}">اضافه کردن نوبت جدید</a></li>
                </ul>
            </li>
...
<div class="header">
    ...
    <div class="header-logo">
        <a href="index.html">
            <img class="small-logo" src="{{url('panel/assets/media/image/reservation.png')}}" alt="image" width="50" height="70">
        </a>
    </div>
    <!-- end::header logo -->
    <!-- begin::header body -->
